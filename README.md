...
a relational database structured to recognize relations among stored items of information. Structured Query Language, an international standard for database manipulation.
2. Why do tables need a `primary key`?
preventing duplicate rows from getting into the database
